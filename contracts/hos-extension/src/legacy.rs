use crate::{HosExtension, PendingSweep, StorageKey};
use near_sdk::near;
...
impl From<HosExtensionV2> for HosExtension {
    fn from(old: HosExtensionV2) -> Self {
        Self {
            ...
            sweep_pending: IterableSet::<PendingSweep>::new(StorageKey::SweepPending),
