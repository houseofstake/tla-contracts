...
pub struct TlaRegistryV4 {
    ...
    pub tla_terms: LookupMap<AccountId, TlaTerms>,
    ...
    pub paid_order_ids: LookupMap<String, PaidOrderState>,
    pub pending_council: Option<AccountId>,
    pub pending_council_at: Option<u64>,
}

impl From<TlaRegistryV4> for TlaRegistry {
    fn from(old: TlaRegistryV4) -> Self {
        Self {
            ...
            lease_term_ns: old.lease_term_ns,
            ...
            paid_order_ids: old.paid_order_ids,
...
impl From<TlaRegistryV2> for TlaRegistry {
    fn from(old: TlaRegistryV2) -> Self {
        Self {
            state_version: crate::STATE_VERSION,
            tlas: old.tlas,
            sub_accounts: old.sub_accounts,
