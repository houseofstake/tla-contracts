...
pub const ONE_YOCTO: &str = "requires an attached deposit of exactly 1 yoctoNEAR";
pub const NO_APPROVED_IMPL: &str = "no approved implementation";
pub const IMPL_PIN_TOO_YOUNG: &str = "approved implementation must wait out the delay";
pub const COLLECTION_MOVED: &str = "collection does not match the one this account was minted into";
pub const PIN_GAS_TOO_LOW: &str = "not enough gas attached to complete the migration";
